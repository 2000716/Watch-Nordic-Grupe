...
.vertical-nav.collapsed + .menu-toggle {
  left: 0;
}
...
.recommendations {
  margin-left: 70px;
  padding: 40px 60px 60px 60px; /* ekstra padding-bottom for å dekke gap */
  background: black;
  transition: margin-left 0.3s ease;
  margin-top: 0; /* fjernet negativ margin */
}

.vertical-nav.collapsed ~ .recommendations {
  margin-left: 0;
}
